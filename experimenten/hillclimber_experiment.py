...
def hillclimb(graph, transmitters):
    ...
    with open("output/hillclimber/hillclimber.csv", 'w', newline='') as output_file:
...
def hillclimb_graph():
    fig, ax = plt.subplots()
    with open("output/hillclimber/hillclimber.csv", 'r') as input_file:
        result_reader = csv.reader(input_file, delimiter=',')
    ...
    fig.savefig("output/hillclimber/single_run.png")


def hillclimber_averages_graph():
    fig, ax = plt.subplots()
    with open("output/hillclimber/hillclimber_averages.csv", 'r') as input_file:
        result_reader = csv.reader(input_file, delimiter=',')
    ...
    fig.savefig("output/hillclimber/hillclimber_averages.png")
...
def hillclimber_averages_filled_graph():
    ...
    ax.set_xlabel('Iteration')
    ax.set_ylabel('Average Total Costs')
    fig.savefig("output/hillclimber/hillclimber_averages_filled.png")

def hillclimber_xopt_comparison_graph():
    fig, ax = plt.subplots()
    results = []
    for n in range(1, 6):
        with open(f"output/hillclimber/hillclimber_xopt_{n}.csv", 'r') as input_file:
            result_reader = csv.reader(input_file, delimiter=',')
    ...
    ax.set_xlabel('Iteration')
    ax.set_ylabel('Total Costs')
    fig.savefig("output/hillclimber/hillclimber_xopt_comparison.png")